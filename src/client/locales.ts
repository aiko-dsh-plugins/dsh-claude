export const zh = {
  nav: 'Claude Code',
  title: 'Claude Code',
  description: '在 DSH 中使用本机 Claude Code 引擎，模型可以来自 DSH 配置或 Claude 原生配置。',
  ...
  modelConfigurationBody: '选择 Claude Code 的模型来源，修改从下一轮对话生效。',
  modelSource: '模型来源',
  modelSourceDsh: '使用 DSH 模型',
  modelSourceNative: '使用 Claude 原生配置',
  modelHaiku: 'Haiku',
  modelSonnet: 'Sonnet',
  modelOpus: 'Opus',
  modelRefresh: '刷新模型列表',
  modelFollowDefault: '跟随 DSH 默认模型',
  modelDshHelp: '从 Cowork 的已配置模型中选择，Haiku、Sonnet、Opus 可分别映射到不同供应商。对话中直接选择 DSH 模型则用于主对话。DSH 技能、连接器和共享资源沿用现有配置；此模式不加载 Claude 设置中的 MCP、Hooks 和插件。',
  modelNativeHelp: '使用本机 Claude Code 的模型、认证及用户、项目配置，不注入 DSH 地址、密钥或角色映射。对话中选择 Claude 型号；已有 DSH 型号会在下一轮改用 Claude 默认型号。',
  ...
  tasksStop: '停止任务',
  tasksStopping: '正在停止…',
  tasksUnavailable: '任务已结束或连接已关闭，请刷新后查看最新状态。',
  tasksStopFailed: '停止请求未确认，请检查任务状态后重试。',
  tasksWorkflowProgress: '展示 Claude Code 返回的工作流状态与进度摘要。',
  tasksPanel: '任务与工作流',
  ...
  tasksTurnStopped: '{stopped} 个任务已停止，{completed} 个已完成',
  ...
  diffLoading: '正在读取工作区改动…',
  diffNotRepository: '当前工作区不是 Git 仓库，暂无可显示的版本差异。',
  diffUnavailable: '暂时无法读取工作区差异。你可以继续对话，稍后再查看。',
...
export const en = {
  nav: 'Claude Code',
  title: 'Claude Code',
  description: 'Use the local Claude Code engine in DSH with models from DSH settings or native Claude configuration.',
  ...
  modelConfigurationBody: 'Choose the model source for Claude Code. Changes apply on the next turn.',
  modelSource: 'Model source',
  modelSourceDsh: 'Use DSH models',
  modelSourceNative: 'Use native Claude configuration',
  modelHaiku: 'Haiku',
  modelSonnet: 'Sonnet',
  modelOpus: 'Opus',
  modelRefresh: 'Refresh model list',
  modelFollowDefault: 'Follow DSH default model',
  modelDshHelp: 'Choose from Cowork’s configured models. Haiku, Sonnet and Opus can use different providers; a direct DSH selection sets the main model. DSH skills, connectors and shared resources retain their existing configuration. Claude settings-based MCP, hooks and plugins are not loaded in this mode.',
  modelNativeHelp: 'Use the local Claude Code models, authentication, user and project settings without DSH endpoints, credentials or role mappings. Select a Claude model in the composer; an existing DSH selection uses the Claude default on the next turn.',
  ...
  tasks: 'Tasks',
  tasksOpen: 'View tasks and workflows',
  tasksAll: 'All',
  tasksSubagents: 'Subagents',
  tasksWorkflows: 'Workflows',
  tasksFilter: 'Task type',
  tasksPaused: 'Paused',
  tasksStop: 'Stop task',
  tasksStopping: 'Stopping…',
  tasksUnavailable: 'The task has ended or its connection closed. Refresh to see its latest state.',
  tasksStopFailed: 'The stop request was not confirmed. Check the task state before retrying.',
  tasksWorkflowProgress: 'Shows workflow state and progress summaries reported by Claude Code.',
  tasksPanel: 'Tasks and workflows',
  ...
  tasksTurnStopped: '{stopped} stopped, {completed} completed',
  ...
  diffLoading: 'Loading workspace changes…',
  diffNotRepository: 'This workspace is not a Git repository. There are no versioned changes to display.',
  diffUnavailable: 'Workspace changes are currently unavailable. You can continue the conversation and check again later.',
